 ...
 * @since 08/02/17
 */
public class SerializableShiroSubjectWrapper implements Serializable {

    private transient Subject shiroSubject;

    public SerializableShiroSubjectWrapper(Subject shiroSubject) {
    ...
    private void writeObject(ObjectOutputStream out) throws IOException {
        ...
        out.writeBoolean(shiroSubject.isAuthenticated());
    }
